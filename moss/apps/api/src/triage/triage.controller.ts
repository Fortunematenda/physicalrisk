...
class ProposalTemplateDto {
  ...
  @IsOptional() @IsString() @MaxLength(100000) understandingOfNeeds?: string;
  ...
  @IsOptional() @IsString() @MaxLength(50000) termsAndConditions?: string;
  @IsOptional() @IsString() @MaxLength(50000) acceptanceTerms?: string;
