...
type AdvisoryBreadcrumbProps = {
   ...
   * Nested pages: back › Diagnostics & assurance › current.
   */
  root?: boolean;
};

/**
 * Matches triage-style breadcrumbs on nested pages.
 * The Diagnostics & assurance list is the home — no back from there.
 */
