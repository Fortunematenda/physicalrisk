...
namespace Protuno\Deps\WP\MCP\Core;

use Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface;
use Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt;
use Protuno\Deps\WP\MCP\Domain\Resources\McpResource;
use Protuno\Deps\WP\MCP\Domain\Tools\McpTool;
use Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface;
use Protuno\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface;
use Protuno\Deps\WP\MCP\Infrastructure\Observability\FailureReason;
use Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt as PromptDto;
use Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource as ResourceDto;
use Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool as ToolDto;
use WP_Error;
...
class McpComponentRegistry {
	 ...
	 *
	 * @var array<string, \Protuno\Deps\WP\MCP\Domain\Tools\McpTool>
	 */
	 ...
	 *
	 * @var array<string, \Protuno\Deps\WP\MCP\Domain\Resources\McpResource>
	 */
	 ...
	 *
	 * @var array<string, \Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt>
	 */
	 ...
	 * MCP Server instance.
	 *
	 * @var \Protuno\Deps\WP\MCP\Core\McpServer
	 */
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface
	 */
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface
	 */
	 ...
	 * Constructor.
	 *
	 * @param \Protuno\Deps\WP\MCP\Core\McpServer $mcp_server MCP server instance.
	 * @param \Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $error_handler Error handler instance.
	 * @param \Protuno\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface $observability_handler Observability handler instance.
	 */
	public function __construct(
		 ...
		 * @param \Protuno\Deps\WP\MCP\Core\McpServer $server        The McpServer instance owning the registry.
		 */
	 ...
	 *
	 * @param list<string|\Protuno\Deps\WP\MCP\Domain\Tools\McpTool> $tools Array of ability names (strings) or McpTool instances.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\Protuno\Deps\WP\MCP\Domain\Tools\McpTool $tool_item The tool to register.
	 *
	 * @return void
	 */
	private function register_single_tool( $tool_item ): void {
		...
		if ( $tool_item instanceof McpTool ) {
			...
			/** @var \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool $tool_dto */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Tools\McpTool $mcp_tool McpTool instance.
	 *
	 * @return void
	 * @since 0.3.0
	 *
	 ...
	 *
	 * @param list<string|\Protuno\Deps\WP\MCP\Domain\Resources\McpResource> $resources Array of ability names or McpResource instances.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\Protuno\Deps\WP\MCP\Domain\Resources\McpResource $resource_item The resource to register.
	 *
	 * @return void
	 */
	private function register_single_resource( $resource_item ): void {
		...
		if ( $resource_item instanceof McpResource ) {
			...
			/** @var \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource $resource_dto */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Resources\McpResource $mcp_resource McpResource instance.
	 *
	 ...
	 *
	 * @param list<string|\Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt|\Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface> $prompts Array of prompts to register.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt|\Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $prompt_item The prompt to register.
	 *
	 * @return void
	 */
	private function register_single_prompt( $prompt_item ): void {
		...
		if ( $prompt_item instanceof McpPrompt ) {
			...
			/** @var \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt_dto */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt $mcp_prompt McpPrompt instance.
	 *
	 * @return void
	 * @since 0.3.0
	 *
	...
	private function add_mcp_prompt( McpPrompt $mcp_prompt ): void {
		/** @var \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder The builder instance.
	 *
	 * @return void
	 */
	...
	private function register_builder_class( string $class_name ): void {
		try {
			/** @var \Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder */
	 ...
	 *
	 * @return array<string, \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool>
	 */
	 ...
	 *
	 * @return array<string, \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource>
	 */
	 ...
	 *
	 * @return array<string, \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Domain\Tools\McpTool|null
	 * @since 0.3.0
	 *
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Domain\Resources\McpResource|null
	 * @internal
	 * @since 0.3.0
	 *
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt|null
	 * @internal
	 * @since 0.3.0
	 *
	 */
	 ...
	 * @param string $prompt_name Prompt name.
	 *
	 * @return \Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface|null
	 */
