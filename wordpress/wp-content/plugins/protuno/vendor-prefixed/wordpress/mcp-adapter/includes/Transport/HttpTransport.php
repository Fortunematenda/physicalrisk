...
namespace Protuno\Deps\WP\MCP\Transport;

use Protuno\Deps\WP\MCP\Transport\Contracts\McpRestTransportInterface;
use Protuno\Deps\WP\MCP\Transport\Infrastructure\HttpRequestContext;
use Protuno\Deps\WP\MCP\Transport\Infrastructure\HttpRequestHandler;
use Protuno\Deps\WP\MCP\Transport\Infrastructure\McpTransportContext;
use Protuno\Deps\WP\MCP\Transport\Infrastructure\McpTransportHelperTrait;
...
class HttpTransport implements McpRestTransportInterface {
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Transport\Infrastructure\HttpRequestHandler
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Transport\Infrastructure\McpTransportContext $transport_context The transport context.
	 */
	...
	public function check_permission( \WP_REST_Request $request ) {
		 ...
		 * @param \Protuno\Deps\WP\MCP\Transport\Infrastructure\HttpRequestContext $context    The HTTP request context.
		 */
