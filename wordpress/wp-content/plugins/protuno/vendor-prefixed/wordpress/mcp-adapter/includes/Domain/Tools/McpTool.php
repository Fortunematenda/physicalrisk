...
namespace Protuno\Deps\WP\MCP\Domain\Tools;
...
use Protuno\Deps\WP\McpSchema\Server\Tools\DTO\ToolAnnotations;
use WP_Error;
...
final class McpTool implements McpComponentInterface {
	 ...
	 *
	 * @var \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool $tool The Tool DTO.
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool
	 */
