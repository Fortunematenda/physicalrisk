...
namespace Protuno\Deps\WP\MCP\Handlers\Prompts;

use Protuno\Deps\WP\MCP\Core\McpServer;
use Protuno\Deps\WP\MCP\Handlers\HandlerHelperTrait;
use Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\McpErrorFactory;
use Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult;
use Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\ListPromptsResult;
use Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt as PromptDto;
use Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage;
...
class PromptsHandler {
	 ...
	 * Constructor.
	 *
	 * @param \Protuno\Deps\WP\MCP\Core\McpServer $mcp The WordPress MCP instance.
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\ListPromptsResult Response with prompts list DTO.
	 */
	public function list_prompts(): ListPromptsResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts Array of Prompt DTOs.
		 * @param \Protuno\Deps\WP\MCP\Core\McpServer                         $server  The MCP server instance.
		 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult|\Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Response with prompt execution results or error.
	 */
	public function get_prompt( array $params, $request_id = 0 ) {
		...
		try {
			 ...
			 * @param \Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt   $mcp_prompt  The MCP prompt instance.
			 * @param \Protuno\Deps\WP\MCP\Core\McpServer             $server      The MCP server instance.
			 */
	 ...
	 * @param \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO for description fallback.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param string $prompt_name Prompt name for logging.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage
	 */
