...
use Protuno\Deps\WP\MCP\Infrastructure\Observability\McpObservabilityHelperTrait;
...
use Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse;
...
class RequestRouter {
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Transport\Infrastructure\McpTransportContext $context The transport context.
	 */
	 ...
	 * @param \Protuno\Deps\WP\MCP\Transport\Infrastructure\HttpRequestContext|null $http_context HTTP context for session management.
	 *
	 * @return array
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\AbstractDataTransferObject
	 */
	 ...
	 * @param mixed $request_id The request ID.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
