...
namespace Protuno\Deps\WP\MCP\Handlers\Tools;

use Protuno\Deps\WP\MCP\Core\McpServer;
use Protuno\Deps\WP\MCP\Domain\Utils\ContentBlockHelper;
...
use Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolResult;
use Protuno\Deps\WP\McpSchema\Server\Tools\DTO\ListToolsResult;
...
class ToolsHandler {
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\ListToolsResult Response with all tools.
	 */
	 ...
	 * to MCP clients.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\ListToolsResult Response with tools list.
	 */
	public function list_tools(): ListToolsResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool> $tools  Array of Tool DTOs.
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolResult|\Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	public function call_tool( array $params, $request_id = 0 ) {
		...
		try {
			 ...
			 * @param \Protuno\Deps\WP\MCP\Domain\Tools\McpTool $mcp_tool  The MCP tool instance.
			 * @param \Protuno\Deps\WP\MCP\Core\McpServer       $server    The MCP server instance.
			 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolResult
	 */
