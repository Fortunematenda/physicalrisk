...
namespace Protuno\Deps\WP\MCP\Handlers\Resources;
...
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents;
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\TextResourceContents;
use Protuno\Deps\WP\McpSchema\Server\Resources\DTO\ListResourcesResult;
use Protuno\Deps\WP\McpSchema\Server\Resources\DTO\ReadResourceResult;
...
class ResourcesHandler {
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\ListResourcesResult Response with resources list.
	 */
	public function list_resources(): ListResourcesResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource> $resources Array of Resource DTOs.
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\ReadResourceResult|\Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	public function read_resource( array $params, $request_id = 0 ) {
		...
		/** @var \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource $resource */
		...
		try {
			 ...
			 * @param \Protuno\Deps\WP\MCP\Domain\Resources\McpResource $mcp_resource The MCP resource instance.
			 * @param \Protuno\Deps\WP\MCP\Core\McpServer               $server       The MCP server instance.
			 */
	 ...
	 * @param string $uri The resource URI.
	 *
	 * @return array<\Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\TextResourceContents|\Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents>
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\TextResourceContents|\Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents
	 */
