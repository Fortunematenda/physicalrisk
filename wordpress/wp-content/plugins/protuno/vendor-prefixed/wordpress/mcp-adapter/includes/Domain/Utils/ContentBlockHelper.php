 ...
 *
 * @package Protuno\Deps\WP\MCP\Domain\Utils
 */

declare( strict_types=1 );

namespace Protuno\Deps\WP\MCP\Domain\Utils;

use Protuno\Deps\WP\McpSchema\Common\Content\DTO\AudioContent;
use Protuno\Deps\WP\McpSchema\Common\Content\DTO\ImageContent;
use Protuno\Deps\WP\McpSchema\Common\Content\DTO\TextContent;
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\Annotations;
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents;
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\EmbeddedResource;
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\TextResourceContents;
use Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface;
...
final class ContentBlockHelper {
	 ...
	 * @param \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\Annotations|null $annotations Optional annotations for the client.
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\Content\DTO\ImageContent The created ImageContent DTO.
	 */
	 ...
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\Content\DTO\AudioContent The created AudioContent DTO.
	 */
	 ...
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\EmbeddedResource The created EmbeddedResource DTO.
	 */
	 ...
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\Content\DTO\TextContent The created TextContent DTO.
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface[] $blocks Array of content block DTOs.
	 *
