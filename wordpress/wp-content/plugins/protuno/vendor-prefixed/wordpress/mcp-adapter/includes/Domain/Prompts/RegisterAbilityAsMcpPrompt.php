...
use Protuno\Deps\WP\MCP\Domain\Utils\McpNameSanitizer;
use Protuno\Deps\WP\MCP\Domain\Utils\McpValidator;
use Protuno\Deps\WP\MCP\Domain\Utils\SchemaTransformer;
...
class RegisterAbilityAsMcpPrompt {
	 ...
	 * @param \WP_Ability $ability The ability.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt|\WP_Error Returns Prompt DTO or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt|\WP_Error Prompt DTO or WP_Error if validation fails.
	 * @since 0.5.0
	 *
	 */
	 ...
	 *
	 * @return list<\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\PromptArgument>|\WP_Error PromptArgument DTOs or WP_Error.
	 * @since 0.5.0
	 *
	 */
	 ...
	 *
	 * @return list<\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\PromptArgument> Argument DTO list.
	 * @since 0.5.0
	 *
	 */
	 ...
	 * @param \WP_Ability $ability The ability.
	 *
	 * @return array{prompt: \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt, adapter_meta: array<string, mixed>}|\WP_Error
	 * @since 0.5.0
	 *
	 */
