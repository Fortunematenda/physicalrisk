...
namespace Protuno\Deps\WP\MCP\Handlers\Initialize;

use Protuno\Deps\WP\MCP\Core\McpServer;
use Protuno\Deps\WP\MCP\Core\McpVersionNegotiator;
use Protuno\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation;
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeResult;
...
class InitializeHandler {
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeResult Response with server capabilities and information.
	 */
	public function handle( string $client_protocol_version ): InitializeResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeResult $result The initialize result DTO.
