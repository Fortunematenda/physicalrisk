...
namespace Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling;

use Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error;
use Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse;
use Protuno\Deps\WP\McpSchema\Common\McpConstants;
...
class McpErrorFactory {
	 ...
	 * @param mixed|null $data Optional additional error data.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse|array $error_response The MCP error response (DTO or array).
	 *
	 ...
	 *
	 * @return true|\Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Returns true if valid, or JSONRPCErrorResponse DTO if invalid.
	 */
