...
namespace Protuno\Deps\WP\MCP\Cli;

use Protuno\Deps\WP\MCP\Core\McpServer;
use Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\McpErrorFactory;
use Protuno\Deps\WP\MCP\Transport\Infrastructure\JsonRpcResponseBuilder;
use Protuno\Deps\WP\MCP\Transport\Infrastructure\RequestRouter;
...
class StdioServerBridge {
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Core\McpServer $server The MCP server to expose.
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
