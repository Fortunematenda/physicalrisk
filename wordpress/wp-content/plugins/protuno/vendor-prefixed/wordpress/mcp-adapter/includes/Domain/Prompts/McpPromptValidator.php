...
use Protuno\Deps\WP\MCP\Domain\Resources\McpResourceValidator;
...
class McpPromptValidator {
	 ...
	 *
	 * @param \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt The prompt DTO to validate.
	 *
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Prompts\McpPrompt $prompt The prompt instance to validate.
	 *
	 * @return bool|\WP_Error True if valid, WP_Error if validation fails.
	 */
