...
class McpToolValidator {
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Tools\McpTool $tool The tool instance to validate.
	 * @param string  $context Optional context for error messages.
	 *
	 * @return bool|\WP_Error True if valid, WP_Error if validation fails.
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\Tool $tool The tool DTO to validate.
	 *
