 ...
 *
 * @package Protuno\Deps\WP\MCP\Core
 */
...
use Protuno\Deps\WP\MCP\Abilities\DiscoverAbilitiesAbility;
use Protuno\Deps\WP\MCP\Abilities\ExecuteAbilityAbility;
use Protuno\Deps\WP\MCP\Abilities\GetAbilityInfoAbility;
use Protuno\Deps\WP\MCP\Cli\McpCommand;
...
use Protuno\Deps\WP\MCP\Servers\DefaultServerFactory;
use WP_Error;
...
final class McpAdapter {
	 ...
	 * Registry instance
	 *
	 * @var \Protuno\Deps\WP\MCP\Core\McpAdapter
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Core\McpAdapter
	 */
	...
	public function init(): void {
		 ...
		 * @since 0.1.0
		 *
		 * @param \Protuno\Deps\WP\MCP\Core\McpAdapter $adapter The MCP Adapter singleton instance.
		 */
	 ...
	 * @param array<class-string<\Protuno\Deps\WP\MCP\Transport\Contracts\McpTransportInterface>> $mcp_transports Array of MCP transport class names to initialize.
	 * @param class-string<\Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface>|null $error_handler The error handler class name. If null, NullMcpErrorHandler will be used.
	 * @param class-string<\Protuno\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface>|null $observability_handler The observability handler class name. If null, NullMcpObservabilityHandler will be used.
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Core\McpAdapter|\WP_Error McpAdapter instance on success, WP_Error on failure.
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Core\McpServer|null
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\MCP\Core\McpServer[]
	 */
