...
class McpResourceValidator {
	 ...
	 *
	 * @param \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource $resource_dto The resource DTO to validate.
	 *
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Resources\McpResource $the_resource The resource instance to validate.
	 *
	 * @return bool|\WP_Error True if valid, WP_Error if validation fails.
	 */
