...
namespace Protuno\Deps\WP\MCP\Transport\Contracts;
...
interface McpTransportInterface {
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Transport\Infrastructure\McpTransportContext $context Dependency injection container.
	 */
