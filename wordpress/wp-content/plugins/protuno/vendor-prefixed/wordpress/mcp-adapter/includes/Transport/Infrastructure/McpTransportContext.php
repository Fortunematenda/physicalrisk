...
namespace Protuno\Deps\WP\MCP\Transport\Infrastructure;

use Protuno\Deps\WP\MCP\Core\McpServer;
use Protuno\Deps\WP\MCP\Handlers\Initialize\InitializeHandler;
use Protuno\Deps\WP\MCP\Handlers\Prompts\PromptsHandler;
use Protuno\Deps\WP\MCP\Handlers\Resources\ResourcesHandler;
use Protuno\Deps\WP\MCP\Handlers\System\SystemHandler;
use Protuno\Deps\WP\MCP\Handlers\Tools\ToolsHandler;
...
class McpTransportContext {
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Handlers\Initialize\InitializeHandler
	 */
	 ...
	 * The tools handler.
	 *
	 * @var \Protuno\Deps\WP\MCP\Handlers\Tools\ToolsHandler
	 */
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Handlers\Resources\ResourcesHandler
	 */
	 ...
	 * The prompts handler.
	 *
	 * @var \Protuno\Deps\WP\MCP\Handlers\Prompts\PromptsHandler
	 */
	 ...
	 * The system handler.
	 *
	 * @var \Protuno\Deps\WP\MCP\Handlers\System\SystemHandler
	 */
	 ...
	 *
	 * @param array{
	 *   mcp_server: \Protuno\Deps\WP\MCP\Core\McpServer,
	 *   initialize_handler: \Protuno\Deps\WP\MCP\Handlers\Initialize\InitializeHandler,
	 *   tools_handler: \Protuno\Deps\WP\MCP\Handlers\Tools\ToolsHandler,
	 *   resources_handler: \Protuno\Deps\WP\MCP\Handlers\Resources\ResourcesHandler,
	 *   prompts_handler: \Protuno\Deps\WP\MCP\Handlers\Prompts\PromptsHandler,
	 *   system_handler: \Protuno\Deps\WP\MCP\Handlers\System\SystemHandler,
	 *   observability_handler: \Protuno\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface,
	 *   request_router?: \Protuno\Deps\WP\MCP\Transport\Infrastructure\RequestRouter,
	 *   transport_permission_callback?: callable|null,
	 *   error_handler?: \Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface
