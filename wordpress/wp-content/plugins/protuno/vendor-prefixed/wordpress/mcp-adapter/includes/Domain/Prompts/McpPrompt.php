...
namespace Protuno\Deps\WP\MCP\Domain\Prompts;

use Protuno\Deps\WP\MCP\Domain\Contracts\McpComponentInterface;
use Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface;
use Protuno\Deps\WP\MCP\Domain\Utils\AbilityArgumentNormalizer;
...
use Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\PromptArgument;
use WP_Error;
...
final class McpPrompt implements McpComponentInterface {
	 ...
	 *
	 * @var \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt
	 */
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface|null
	 */
	 ...
	 *
	 * @param \Protuno\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder Builder instance.
	 *
	 * @return self|\WP_Error
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt
	 */
