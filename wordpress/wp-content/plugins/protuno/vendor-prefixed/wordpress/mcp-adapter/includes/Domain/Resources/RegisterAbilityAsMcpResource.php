...
namespace Protuno\Deps\WP\MCP\Domain\Resources;

use Protuno\Deps\WP\MCP\Domain\Utils\McpAnnotationMapper;
use Protuno\Deps\WP\MCP\Domain\Utils\McpValidator;
...
class RegisterAbilityAsMcpResource {
	 ...
	 *
	 * @var \Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null
	 */
	 ...
	 * @param \Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Optional error handler.
	 */
	 ...
	 *
	 * @param \WP_Ability $ability The ability.
	 * @param \Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Optional error handler for logging.
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource|\WP_Error Returns Resource DTO or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource|\WP_Error Returns the Resource DTO or WP_Error if validation fails.
	 */
	 ...
	 * @param \Protuno\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Optional error handler.
	 *
	 * @return array{resource: \Protuno\Deps\WP\McpSchema\Server\Resources\DTO\Resource, adapter_meta: array<string, mixed>}|\WP_Error
	 * @since 0.5.0
	 *
	 */
