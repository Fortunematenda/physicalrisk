...
class PromptMessage extends AbstractDataTransferObject
{
     ...
     * @since 2024-11-05
     *
     * @var \Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface
     */
    protected ContentBlockInterface $content;

    /**
     * @param 'user'|'assistant' $role @since 2024-11-05
     * @param \Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface $content @since 2024-11-05
     */
     ...
     * @param array{
     *     role: 'user'|'assistant',
     *     content: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface $content */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface
     */
