...
class GetPromptRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams
     */
     ...
     * @param \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'prompts/get',
     *     params: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams $params */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams
     */
