...
class ListPromptsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
     */
    protected array $prompts;

    /**
     * @param array<\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts @since 2024-11-05
     ...
     *     prompts: array<array<string, mixed>|\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts */
        $prompts = array_map(
    ...
    /**
     * @return array<\Protuno\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
     */
