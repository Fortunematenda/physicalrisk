...
class ElicitationCompleteNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    /**
     * @var \Protuno\Deps\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams
     */
    protected ElicitationCompleteNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \Protuno\Deps\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams $params @since 2025-11-25
     */
     ...
     *     params: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams $params */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams
     */
