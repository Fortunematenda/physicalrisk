...
use Protuno\Deps\WP\McpSchema\Common\Protocol\Factory\ContentBlockFactory;
use Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface;
use Protuno\Deps\WP\McpSchema\Common\Protocol\Union\SamplingMessageContentBlockInterface;
...
class ToolResultContent extends AbstractDataTransferObject implements SamplingMessageContentBlockInterface
{
     ...
     * @since 2025-11-25
     *
     * @var array<\Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface>
     */
     ...
     * @param array<\Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface> $content @since 2025-11-25
     ...
     *     type: 'tool_result',
     *     toolUseId: string,
     *     content: array<array<string, mixed>|\Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface>,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface> $content */
        $content = array_map(
    ...
    /**
     * @return array<\Protuno\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface>
     */
