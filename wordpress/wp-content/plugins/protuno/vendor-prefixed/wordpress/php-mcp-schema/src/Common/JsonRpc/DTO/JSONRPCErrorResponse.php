...
class JSONRPCErrorResponse extends AbstractDataTransferObject implements JSONRPCResponseInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error
     */
    protected Error $error;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error $error @since 2025-11-25
     ...
     *     error: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error $error */
