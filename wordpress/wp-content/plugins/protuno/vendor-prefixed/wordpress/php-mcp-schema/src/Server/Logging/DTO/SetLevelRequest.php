...
class SetLevelRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\SetLevelRequestParams
     */
     ...
     * @param \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\SetLevelRequestParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Server\Logging\DTO\SetLevelRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\SetLevelRequestParams $params */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\SetLevelRequestParams
     */
