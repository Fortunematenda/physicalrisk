...
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\PaginatedRequest;
use Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams;
...
class ListResourcesRequest extends PaginatedRequest implements ClientRequestInterface
{
     ...
     * @param \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams|null $params @since 2024-11-05
     */
     ...
     *
     * @param array{
     *     params?: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams|null,
     *     jsonrpc: '2.0',
     *     id: string|number,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams|null $params */
