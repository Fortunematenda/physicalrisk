...
class CompleteResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var \Protuno\Deps\WP\McpSchema\Server\Core\DTO\CompleteResultCompletion
     */
    protected CompleteResultCompletion $completion;

    /**
     * @param \Protuno\Deps\WP\McpSchema\Server\Core\DTO\CompleteResultCompletion $completion @since 2024-11-05
     ...
     *     completion: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Server\Core\DTO\CompleteResultCompletion
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Server\Core\DTO\CompleteResultCompletion $completion */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Server\Core\DTO\CompleteResultCompletion
     */
