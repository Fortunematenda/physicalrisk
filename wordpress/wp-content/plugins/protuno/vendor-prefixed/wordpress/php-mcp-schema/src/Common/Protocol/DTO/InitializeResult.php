...
use Protuno\Deps\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities;
use Protuno\Deps\WP\McpSchema\Server\Lifecycle\Union\ServerResultInterface;
...
class InitializeResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var \Protuno\Deps\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities
     */
     ...
     * @param \Protuno\Deps\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities $capabilities @since 2024-11-05
     * @param \Protuno\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation $serverInfo @since 2024-11-05
     ...
     *     capabilities: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities,
     *     serverInfo: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities $capabilities */
        $capabilities = is_array($data['capabilities'])
            ? ServerCapabilities::fromArray(self::asArray($data['capabilities']))
            : $data['capabilities'];

        /** @var \Protuno\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation $serverInfo */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities
     */
