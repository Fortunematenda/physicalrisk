...
namespace Protuno\Deps\WP\McpSchema\Client\Tasks\DTO;
...
class CreateTaskResult extends Result
{
     ...
     * @since 2025-11-25
     *
     * @var \Protuno\Deps\WP\McpSchema\Client\Tasks\DTO\Task
     */
    protected Task $task;

    /**
     * @param \Protuno\Deps\WP\McpSchema\Client\Tasks\DTO\Task $task @since 2025-11-25
     ...
     *     task: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Client\Tasks\DTO\Task
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Client\Tasks\DTO\Task $task */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Client\Tasks\DTO\Task
     */
