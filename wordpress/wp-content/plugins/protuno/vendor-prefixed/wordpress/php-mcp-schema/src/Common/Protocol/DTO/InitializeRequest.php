...
class InitializeRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams
     */
     ...
     * @param \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'initialize',
     *     params: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams $params */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams
     */
