...
class CallToolRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams
     */
     ...
     * @param \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'tools/call',
     *     params: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams $params */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams
     */
