...
namespace Protuno\Deps\WP\McpSchema\Server\Logging\DTO;
...
class LoggingMessageNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    /**
     * @var \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\LoggingMessageNotificationParams
     */
    protected LoggingMessageNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\LoggingMessageNotificationParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\Protuno\Deps\WP\McpSchema\Server\Logging\DTO\LoggingMessageNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\LoggingMessageNotificationParams $params */
    ...
    /**
     * @return \Protuno\Deps\WP\McpSchema\Server\Logging\DTO\LoggingMessageNotificationParams
     */
