...
type Props = {
  /** When false, idle tracking is paused (e.g. not signed in). */
  enabled: boolean;
  /** Full SSO end — portal federated logout URL, or app-local logout handler. */
  onTimeout: () => void;
};

/**
 * Logs the user out after a period of mouse/keyboard/touch inactivity.
 * Shows a short warning banner before signing out.
 */
